...
configs_list = [
    ...
    # SAR image
    './configs/cfg_openearthmap_sar.py',
    './configs/cfg_ddhrnet_korea_sar.py',
    './configs/cfg_ddhrnet_shandong_sar.py',
    './configs/cfg_ddhrnet_xian_sar.py',
    './configs/cfg_fusar_sar.py',
    './configs/cfg_whu_sar.py',
    './configs/cfg_yeseg_sar.py',
    './configs/cfg_pie_sar.py',
]
